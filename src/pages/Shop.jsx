...
function Shop() {
  ...
  return (
    <CustomContainer {...customConfig}>
      <div className="col-md-3  filter-col pe-0">
        <aside className="">
          <div id="filterBar">
            <div className=" filter-nav my-3 mx-2 px-2">
              <span className="close-filter" onclick="closeFilterbar()">
                <svg
                  width="14"
                  height="14"
                  viewBox="0 0 14 15"
            ...
            <div className="filter-content fs-large pb-5 fw-500 ">
              <div className="filterbar-links mx-auto w-60 ">
                <div className=" filter-borderbl px-1 mb-4 d-flex mx-0">
                  {" "}
                  <div className="fw-700 col-7 ">Filter</div>{" "}
                  <div className="col-4">Clear</div>
                </div>
                <div className=" filter-borderbl mb-4 px-1 d-flex mx-0 dropdown">
                  {" "}
                  <div className="fw-700 col-7">Sex</div>
                  <div
                    className="col-5 fs-lgr fw-700 red text-center btn dropdown-toggle"
                    type="button"
                ...
                <div className=" filter-borderbl mb-4 px-1 d-flex mx-0 dropdown">
                  {" "}
                  <div className="fw-700 col-7">Size</div>
                  <div
                    className="col-5 fs-lgr fw-700 red text-center btn dropdown-toggle"
                    type="button"
                    id="dropdownMenuButton"
                ...
                <div className=" filter-borderbl mb-4 px-1 d-flex mx-0 dropdown">
                  {" "}
                  <div className="fw-700 col-7">Color</div>
                  <div
                    className="col-5 fs-lgr fw-700 red text-center btn dropdown-toggle"
                    type="button"
                    id="dropdownMenuButton"
              ...
              <div className="filterbar-links mx-auto w-60">
                ...
                <div className="filter-sublinks px-2">
                  <a href="">
                    <div>Bra Top</div>
                  </a>
                  <a href="">
              ...
              <div className="filterbar-links mx-auto w-60">
                ...
                <div className="filter-sublinks px-2">
                  <a href="">
                    <div>Steel Bone Lattex Trainer</div>
                  </a>
                  <a href="">
          ...
          <div className="nav-sm-container d-flex pt-3 px-4">
            <div className="open-filter" onclick="openFilterbar()">
              <svg
                width="68"
                height="25"
                viewBox="0 0 64 13"
      ...
      <div className="col-md-9 shop-catalog ">
        <div className="row mx-0 px-4 justify-content-between">
          <div className=" shop-col">
            <h5 className="d-s-none col-header">Women Bottom</h5>
            <img src="assets/images/video-substitute.png" alt="" />
          ...
          <div className=" shop-col">
            <h5 className="d-s-none col-header">Waist Trainers</h5>
            <img
              src="assets/images/video-substitute.png"
              className="col-head-img"
              alt=""
            />
            <div className="shop-col-text">
              <p className="fw-700">Lycra Atheletic Short</p>
          ...
          <div className=" shop-col">
            <h5 className="d-s-none col-header">Full Set</h5>
            <img
              src="assets/images/video-substitute.png"
              className="col-head-img"
              alt=""
          ...
          <div className=" shop-col">
            <h5 className="d-s-none col-header">Tees</h5>
            <img src="assets/images/video-substitute.png" alt="" />
            <div className="shop-col-text">
              <p className="fw-700">Lycra Atheletic Short</p>
              <p># 7,000.00 / $ 17</p>
        ...
        <div className="d-l-none">
          <div className="d-flex mx-0 w-40 mx-auto mt-3 mb-6 justify-content-between  ">
            <div className=" pages-catalog">1</div>
            <div className=" pages-catalog">2</div>
            <div className=" pages-catalog">3</div>
            <div className=" pages-catalog">4</div>
            <div className=" pages-catalog">5</div>
          </div>
        </div>
      </div>
    </CustomContainer>
