    ...
    <footer className={classes.root}>
      <Grid container justifyContent="center">
        <Grid item={true} xs={12} sm={11} md={11}>
            ...
            <Grid item={true} xs={5} sm={5} md={5} className="flex">
              <div className="mx-s-auto ">
                <div className="email-text-align">
                  <p className="font-[600] signup-align mr-2 mb-3">
          ...
          <div className="paymentMethodCon flex mx-0 px-3">
            <div className="payment-method w-full">
              <p className="font-bold">Accepted Payment Partners</p>
              <div className="payment-icon w-[20rem] ">
                <AcceptedCardsSvg />
              </div>
            </div>
          </div>
